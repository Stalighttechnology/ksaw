...
async function runUpdate() {
  console.log("=== Processing L-10.09.2026.xlsx: Update Status to 'Sent to Department' ===");

  // 1. Authenticate with an admin session
  const authEmail = `updater_l_${Date.now()}@gleamator.com`;
  ...
  const excelFilePath = path.resolve(__dirname, "../public/L-10.09.2026.xlsx");
  ...
  console.log(`Extracted ${excelRecords.length} student records from L-10.09.2026.xlsx.`);
